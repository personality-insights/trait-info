...
const PersonalityTraitInfo  = require('../src/index');

describe('info', () => {

  it('get trait information', () => {
  ...
  it('get trait bits of information', () => {
    const traitInfo = new PersonalityTraitInfo();
    assert.equal(traitInfo.name('Agreeableness'), 'Agreeableness');
    ...
    assert.equal(traitInfo.names()[1], 'Altruism');
  });
